...
public class SplitPractice3 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < text.length(); i++) {//if ir letter or no if no we repalced with empty
        ...
        System.out.println("The amount of words what we have+"+count);
    }
}
